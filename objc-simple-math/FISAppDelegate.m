...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    /* sqrt(2) to 50 decimal places is 1.41421356237309504880168872420969807856967187537695
    according to wolframalpha. Thus math.h can only calculated sqrt(2) to 15 decimal places in both case */
